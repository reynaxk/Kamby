...
export function WelcomeHero({ onStartTrading }: { onStartTrading: () => void }) {
  return (
    <motion.div
      ...
      initial="hidden"
      animate="show"
      className="mx-auto flex max-w-3xl flex-col items-center gap-5 px-6 pb-16 pt-20 text-center sm:pt-28"
    >
      <motion.span
        variants={item}
      ...
      <motion.h1
        variants={item}
        className="font-display text-4xl font-extrabold tracking-tight text-ink-900 sm:text-5xl"
      >
